...
# Each instance of the Movie class has 4 parameters:
#  Movie title, a description of the movie, a poster image,
# and a youtube link to the trailer.

anchorman = media.Movie("Anchorman",
                        "A comedy about the anchorman, Ron Burgandy",
...
pineapple_express = media.Movie("Pineapple Express",
                                "Seth Rogan witnesses a murder by a weed cartel\
                                 and goes to his pot dealer for help",
...
tog = media.Movie("The Other Guys",
                  "A comedy about 2 cops",
...
inception = media.Movie("Inception",
                        "Extractors perform coorperate espionage by using technology \
                        to infiltrate the subconcious of their targets.",
                        "http://ia.media-imdb.com/images/M/MV5BMjAxMzY3NjcxNF5BMl5BanBnXkFtZTcwNTI5OTM0Mw@@._V1_SX640_SY720_.jpg",
                        "https://www.youtube.com/watch?v=8hP9D6kZseM")

interstellar = media.Movie("Interstellar",
                           "Global decline of resources on Earth \
                            leads a group to search for a new planet",
...
ilym = media.Movie("I Love You Man",
                   "A story of a real estate investor \
                    whos search for a best man ends in friendship.",
...
movies = [anchorman, ilym, tog, inception, interstellar, pineapple_express]

# Call the function open_movies_page(movies) in the fresh_tomatoes.py file.
# This generates the html file with the information above.
